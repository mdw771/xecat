...
thickls = [int(16e6), int(100e6), int(500e6), int(1000e6)]
...
for energy in energyls:
    ...
    plt.title('Protein at '+str(energy)+' keV')

    pl_pc, = plt.plot(t_cm, i_pc, label = 'Phase contrast image (PCI) signal', color='blue')
    if fig_index == 1:
        plt.text(0.41,1.8e-13,'Phase contrast\nimage (PCI) signal', fontsize=8, color='blue',rotation=-55)
    if fig_index == 2:
        plt.text(3.55,1.8e-13,'Phase contrast\nimage (PCI) signal', fontsize=8, color='blue',rotation=-50.2)
    if fig_index == 3:
        plt.text(23.2,1.8e-13,'Phase contrast\nimage (PCI) signal', fontsize=8, color='blue',rotation=-44)
    if fig_index == 4:
        plt.text(43,6e-9,'Phase contrast image (PCI) signal', fontsize=8, color='blue',rotation=-34.2)

    pl_elplpc, = plt.plot(t_cm, i_elplpc, label = 'Plural elastically scattered in PCI background', color='green')
    if fig_index == 1:
        plt.text(0.02,3e-16,'Plural elastically\nscattered in PCI\nbackground', fontsize=8, color='green',rotation=-50)
    if fig_index == 2:
        plt.text(0.6,3e-16,'Plural elastically\nscattered in PCI\nbackground', fontsize=8, color='green',rotation=-45)
    if fig_index == 3:
        plt.text(4.2,5e-15,'Plural elastically scattered\nin PCI background', fontsize=8, color='green',rotation=-38)
    if fig_index == 4:
        plt.text(11,2e-15,'Plural elastically scattered\nin PCI background', fontsize=8, color='green',rotation=-27)

    pl_inelpc, = plt.plot(t_cm, i_inelpc, label = 'Inelastically scattered in PCI background', color='red')
    if fig_index == 1:
        plt.text(0.1,5e-13,'Inelastically scattered\nin PCI background', fontsize=8, color='red',rotation=-53)
    if fig_index == 2:
        plt.text(1,5e-13,'Inelastically scattered\nin PCI background', fontsize=8, color='red',rotation=-47)
    if fig_index == 3:
        plt.text(4.5,1e-11,'Inelastically scattered in PCI background', fontsize=8, color='red',rotation=-38)
    if fig_index == 4:
        plt.text(14,1e-11,'Inelastically scattered in PCI background', fontsize=8, color='red',rotation=-22)

    pl_noscat, = plt.plot(t_cm, i_noscat, label = 'Unscattered', color='pink')

    pl_1el, = plt.plot(t_cm, i_1el, label = 'Single elastically scattered', color='black')
    if fig_index == 1:
        plt.text(t_cm[label_pos]+0.008,i_1el[label_pos],'Single elastically scattered', fontsize=8, color='black',rotation=-56)
    if fig_index == 2:
        plt.text(t_cm[label_pos]+0.18,i_1el[label_pos],'Single elastically scattered', fontsize=8, color='black',rotation=-50)
    if fig_index == 3:
        plt.text(t_cm[label_pos]+0.4,i_1el[label_pos],'Single elastically scattered', fontsize=8, color='black',rotation=-43)
    if fig_index == 4:
        plt.text(t_cm[label_pos]+1.2,i_1el[label_pos],'Single elastically scattered', fontsize=8, color='black',rotation=-33)

    pl_elpl, = plt.plot(t_cm, i_elpl, label = 'Plural elastically scattered', color='darkcyan')
    if fig_index == 1:
        plt.text(0.1,4e-8,'Plural elastically\nscattered', fontsize=8, color='darkcyan',rotation=-52)
    if fig_index == 2:
        plt.text(0.1,1.5e-6,'Plural\nelastically\nscattered', fontsize=8, color='darkcyan',rotation=-36)
    if fig_index == 3:
        plt.text(33,6e-14,'Plural elastically scattered', fontsize=8, color='darkcyan',rotation=-43)
    if fig_index == 4:
        plt.text(3,1.25e-5,'Plural\nelastically\nscattered', fontsize=8, color='darkcyan',rotation=-11)

    pl_inel, = plt.plot(t_cm, i_inel, label = 'Inelastically scattered', color='magenta')
    if fig_index == 1:
        plt.text(0.145,1e-4,'Inelastically scattered', fontsize=8, color='magenta',rotation=-56)
    if fig_index == 2:
        plt.text(6,3e-16,'Inelastically\nscattered', fontsize=8, color='magenta',rotation=-52)
    if fig_index == 3:
        plt.text(t_cm[label_pos]+0.4,i_inel[label_pos],'Inelastically scattered', fontsize=8, color='magenta',rotation=-39)
    if fig_index == 4:
        plt.text(t_cm[label_pos]+2,i_inel[label_pos],'Inelastically scattered', fontsize=8, color='magenta',rotation=-22)

    pl_out, = plt.plot(t_cm, i_out, label = 'Scattered out', color='orange')
    if fig_index == 1:
        plt.text(t_cm[label_pos],i_out[label_pos]+4e-3,'Scattered out', fontsize=8, color='orange',rotation=0)
    if fig_index == 2:
        plt.text(t_cm[label_pos],i_out[label_pos]+2e-2,'Scattered out', fontsize=8, color='orange',rotation=0)
    if fig_index == 3:
        plt.text(t_cm[label_pos],i_out[label_pos]-0.15,'Scattered out', fontsize=8, color='orange',rotation=0)
    if fig_index == 4:
        plt.text(t_cm[label_pos],i_out[label_pos]-0.55,'Scattered out', fontsize=8, color='orange',rotation=0)

    pl_pi, = plt.plot(t_cm, i_pi, label = 'Absorbed', color='grey')
    if fig_index == 1:
        plt.text(t_cm[label_pos]+0.48,i_pi[label_pos]-0.74,'Absorbed', fontsize=8, color='grey',rotation=0)
    if fig_index == 2:
        plt.text(t_cm[label_pos]+3.4,i_pi[label_pos]-0.66,'Absorbed', fontsize=8, color='grey',rotation=0)
    if fig_index == 3:
        plt.text(t_cm[label_pos],i_pi[label_pos]-0.48,'Absorbed', fontsize=8, color='grey',rotation=0)
    if fig_index == 4:
        plt.text(t_cm[label_pos]+30,i_pi[label_pos]-0.23,'Absorbed', fontsize=8, color='grey',rotation=0)
