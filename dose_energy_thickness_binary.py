...
energy = 10 ** energy
t_b = np.linspace(np.log10(1), np.log10(1e3), 500)
t_b = 10 ** t_b
t_f = 0.02
...
# energy = np.linspace(np.log10(0.1), np.log10(20), 500)
# energy = 10 ** energy
# t_b = np.linspace(np.log10(1), np.log10(200), 500)
# t_b = 10 ** t_b
# t_f = 0.01
#
# feature_den = 1.35
...
#
# ultramic Fig 14 ================================================================
# energy = np.linspace(np.log10(5), np.log10(50), 500)
# energy = 10 ** energy
# t_b = np.linspace(np.log10(1e3), np.log10(100e3), 500)
# t_b = 10 ** t_b
# t_f = 0.1
#
# feature_den = 1.35
...
f = h5py.File('DEt_bin_{}_in_{}_r{}um.h5'.format(sample.feature_alias, sample.matrix_alias, t_f), 'w')
